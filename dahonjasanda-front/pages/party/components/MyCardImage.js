...
const CardImage = ({ horizontal, images, href, badges, wishlistButton, light, isLoggedIn }) => {
  ...
  return (
    <div className='card-img-top card-img-hover d-flex'>
      ...
      {wishlistButton && isLoggedIn && (
  <div className={`${wishlistButton.active ? 'position-absolute zindex-5' : 'content-overlay'} end-0 top-0 pt-3 pe-3`}>
