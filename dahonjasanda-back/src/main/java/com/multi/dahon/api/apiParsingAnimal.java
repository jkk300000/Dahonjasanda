...
public class apiParsingAnimal {
	
	public static void main(String[] args) {
		List<Animal> list1 = parse();
...
//식물 전체 리스트 파싱
	public static List<Animal> parse() {
...
//					conn.setRequestProperty("content-type", "application/json");
					...
					System.out.println("@@@@ 동물 Basic parsing 시작 ");
...
//								System.out.println("officetel    : " + getStrData(eElement, "officetel"));
								...
								System.out.println("========================여기 오나@@@@@@@@@@============================");
								 ...
								 Animal animal = new Animal(anno, orgCd, orgdownNm, orgdownNm2, orgdownNm2, orgCd2, anno, careAddr, kindCd, KNm, desertionNo, filename, happenDt, happenPlace, colorCd, age, weight, noticeNo, noticeSdt, noticeEdt, popfile, processState, sexCd, neuterYn, specialMark, careTel, careAddr, orgNm, chargeNm, officetel);
...
//		String dateStr = searchDate.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
		...
		urlBuffer.append("?" + "upr_cd=" + animal.getOrgCd()); // org이지만 upr로 활용됌
		urlBuffer.append("&" + "serviceKey" + "=" + KEY);

		System.out.println("@@@@@@@@@@ upr_cd: "+ animal.getOrgCd());
		System.out.println(urlBuffer);
...
//					conn.setRequestProperty("content-type", "application/json");
					...
					System.out.println("동물 parsing 시작 22");
						...
						if (node.getNodeType() == Node.ELEMENT_NODE) {
							try {
								...
								System.out.println("==========================" + count+" ============================");
								 ...
								 animal.setOrgdownNm2(orgdownNm);
								 animal.setOrgCd2(orgCd);
...
//	}
	...
	public static Animal DetailParse4(Animal animal) {
//		String dateStr = searchDate.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
		List<Animal> Detaillist = new ArrayList<>();
		...
		urlBuffer.append("&" + "pageNo" + "=" + "1");  
		urlBuffer.append("&" + "orgCd" + "=" + animal.getOrgCd2());  
		urlBuffer.append("&" + "numOfRows" + "=50");  
		urlBuffer.append("&" + "serviceKey" + "=" + KEY);
